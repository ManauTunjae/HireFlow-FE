...
const JobFormModal = ({ isOpen, onClose, onSubmit, formLoading, formError }) => {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 border border-gray-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden p-6 space-y-4">
        ...
        <form onSubmit={handleLocalSubmit} className="space-y-4 text-sm">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 mb-1">Salary Range</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 mb-1">Requirements (separated with comma)</label>
            <input
              type="text"
