    ...
    try {
      ...
      setFormError(
        error.response?.data?.message ||
          "Kunde inte skapa jobb. Kontrollera fälten.",
      );
    } finally {
        ...
        {selectedJob ? (
          <>
            ...
            <div className="p-6 flex-1 flex gap-4 overflow-x-auto">
              ...
              <div className="w-72 flex-shrink-0 bg-gray-900/30 p-4 rounded-xl border border-gray-800/50 flex flex-col h-fit max-h-full opacity-60">
                <div className="flex justify-between items-center mb-4">
                  <span className="font-bold text-xs text-gray-500 tracking-wider uppercase">
                    Interview
                  </span>
                  <span className="px-2 py-0.5 text-xs bg-gray-950 text-gray-600 rounded-md font-bold">
                    0
                  </span>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Select or create a job from the left sidebar to view the
              recruitment flow.
            </p>
          </div>
        )}
